  ...
  return (
    <div className="flex flex-wrap items-center justify-end gap-1">
      <button
        ...
        className={`rounded-full border bg-paper px-2 py-0.5 text-xs ${
      ...
      {others.map((row) => (
        <button
          ...
          className="rounded-full border border-rule bg-paper px-2 py-0.5 text-xs hover:bg-paper-dark"
        >
          {row.emoji} {row.count}
        </button>
      ))}
      <div className="relative">
        <button
          ...
          className="rounded-full border border-rule bg-paper px-2 py-0.5 text-xs text-ink-soft hover:bg-paper-dark"
        >
          +
        </button>
        {open ? (
